#' Sampler over the knapsack-extension
...
#' @param a Objective function of the knapsack set description
#' @param b Upper bound of the knapsack set describtion
...
#' @export
knapsack_sampler <- function(A, y, n.samples = 1e5, n.chains = 4, n.burnin = 1e4, B = NULL, CPLB_idx = NULL, x.start = NULL, a = 0, b = 0, ldelta = 0, w = 0){
  n = nrow(A)
  r = ncol(A)
  ...
  for(i in 1:n.chains){
    x = x.start[i,]
    for(j in 1:n.burnin){
      x.star = proposePoint_knapsack(x, B, CPLB_idx, a, b)
